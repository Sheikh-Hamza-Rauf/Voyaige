...
hotel_df = load_data('D:\\Voyaige\\chatbot\\Cleaned\\new_hotel_data.csv')
ratings_df = load_data('D:\\Voyaige\\chatbot\\Cleaned\\clean_hotel_review_data.json', 'json')
restaurant_df = load_data('D:\\Voyaige\\chatbot\\Cleaned\\new_restaurant_db.restaurants_data.json', 'json')
attraction_df = load_data('D:\\Voyaige\\chatbot\\Cleaned\\Cleaned_attr.csv')
airbnb_df = load_data('D:\\Voyaige\\chatbot\\Cleaned\\Cleaned_Airbnb.csv')
busses_df = load_data('D:\\Voyaige\\chatbot\\Cleaned\\Cleaned_busses.csv')
cars_df = load_data('D:\\Voyaige\\chatbot\\Cleaned\\Cleaned_Cars.csv')
trains_df = load_data('D:\\Voyaige\\chatbot\\Cleaned\\Cleaned_trains.csv')
...
restaurant_ratings_df = load_data('D:\\Voyaige\\chatbot\\Cleaned\\new_restaurant_db.restaurants_reviews.json', 'json')
...
amenities_data
ratings_df = pd.read_csv('D:\\Voyaige\\chatbot\\Cleaned\\ratings.csv')

# Load embeddings from the specified files
hotel_embeddings = np.load('D:\\Voyaige\\chatbot\\Embeddings\\hotel_embeddings.npy')
restaurant_embeddings = np.load('D:\\Voyaige\\chatbot\\Embeddings\\restaurant_embeddings.npy')
attraction_embeddings = np.load('D:\\Voyaige\\chatbot\\Embeddings\\attr_embeddings.npy')
airbnb_embeddings = np.load('D:\\Voyaige\\chatbot\\Embeddings\\airbnb_embeddings.npy')
bus_embeddings = np.load('D:\\Voyaige\\chatbot\\Embeddings\\buses_embeddings.npy')
car_embeddings = np.load('D:\\Voyaige\\chatbot\\Embeddings\\cars_embeddings.npy')
train_embeddings = np.load('D:\\Voyaige\\chatbot\\Embeddings\\trains_embeddings.npy')

hotel_names = np.load('D:\\Voyaige\\chatbot\\Names\\hotel_names.npy', allow_pickle=True)
restaurant_names = np.load('D:\\Voyaige\\chatbot\\Names\\restaurant_names.npy', allow_pickle=True)
attraction_names = np.load('D:\\Voyaige\\chatbot\\Names\\attraction_names.npy', allow_pickle=True)
airbnb_names = np.load('D:\\Voyaige\\chatbot\\Names\\airbnb_names.npy', allow_pickle=True)
car_names = np.load('D:\\Voyaige\\chatbot\\Names\\car_names.npy', allow_pickle=True)
bus_names = np.load('D:\\Voyaige\\chatbot\\Names\\bus_names.npy', allow_pickle=True)
train_names = np.load('D:\\Voyaige\\chatbot\\Names\\train_names.npy', allow_pickle=True)

model_name = "C:\\Users\\aamir\\Downloads\\fine_tuned_gpt2_1\\fine_tuned_gpt2_1"
